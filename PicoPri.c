...
static _NIL_TYPE_ MOD(_NIL_TYPE_);                                                      //TOEGEVOEGD
static _NIL_TYPE_ MOd(_NIL_TYPE_);                                                      //TOEGEVOEGD
...
{ _EXP_TYPE_ mod, dct, nam;
    _stk_peek_EXP_(mod);
    dct = _ag_get_MOD_DCT_(mod);
  _print_("<module, public:[");
    if (!_ag_is_VOI_(dct)) {
        nam = _ag_get_DCT_NAM_(dct);
        _print_(_ag_get_TXT_(nam)); //print het eerste publieke element
...
/*------------------------------------------------------------------------*/                                        //TOEGEVOEGD
/*  MOd                                                                   */
/*     expr-stack: [... ... ... ... TAB NBR] -> [... ... ... ... TAB NBR] */
/*     cont-stack: [... ... ... ... ... MOd] -> [... ... ... ... ... MOd] */
/*                                                                        */
/*     expr-stack: [... ... ... ... TAB NBR] -> [... ... ... ... ... EOL] */
/*     cont-stack: [... ... ... ... ... MOd] -> [... ... ... ... ... ...] */
/*------------------------------------------------------------------------*/
static _NIL_TYPE_ MOd(_NIL_TYPE_) //print overige publieke elementen
 { _EXP_TYPE_ dct, nam;
   _stk_peek_EXP_(dct);
     if (!_ag_is_VOI_(dct)) {
         nam = _ag_get_DCT_NAM_(dct);
         _print_(", ");
         _print_(_ag_get_TXT_(nam));
         dct = _ag_get_DCT_DCT_(dct);
         _stk_poke_EXP_(dct);
     } else {
         _stk_poke_EXP_(_EOLN_);
