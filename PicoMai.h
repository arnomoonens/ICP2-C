...
#define TAB_OWN_INDEX 1                                                     //TOEGEVOEGD

#define MOD_DCT_INDEX 1                                                     //TOEGEVOEGD
#define MOD_OWN_INDEX 2                                                     //TOEGEVOEGD

#define MRF_MOD_INDEX 1                                                     //TOEGEVOEGD
#define MRF_INV_INDEX 2                                                     //TOEGEVOEGD
...
#define _DCT_SIZE_    3
#define _ENV_SIZE_    4
#define _MOD_SIZE_    2                                                     //TOEGEVOEGD
#define _MRF_SIZE_    2                                                     //TOEGEVOEGD
#define _TAB_SIZE_    1                                                     //TOEGEVOEGD
/* private macros */
...
#define _ag_make_TAB_(SIZ)\
  _mem_make_chunk_(SIZ+_TAB_SIZE_, _TAB_TAG_)
...
#define _ag_make_ENV_()\
  _mem_make_chunk_(_ENV_SIZE_, _ENV_TAG_)
                                                                    //TOEGEVOEGD
#define _ag_make_MOD_()\
  _mem_make_chunk_(_MOD_SIZE_, _MOD_TAG_)
                                                                    //TOEGEVOEGD
#define _ag_make_MRF_()\
  _mem_make_chunk_(_MRF_SIZE_, _MRF_TAG_)
...
#define _ag_get_TAB_SIZ_(TAB)\
 _mem_chunk_size_(TAB)-_TAB_SIZE_
                                                                    //AANGEPAST
#define _ag_get_TAB_OWN_(TAB)\
 _mem_get_exp_(CHK_AGR(TAB, _TAB_TAG_), TAB_OWN_INDEX)
                                                                    //AANGEPAST
#define _ag_get_TAB_EXP_(TAB, IDX)\
 _mem_get_exp_(TAB, IDX+_TAB_SIZE_)
                                                                    //AANGEPAST
#define _ag_get_TAB_CNT_(TAB, IDX)\
 _mem_get_cnt_(TAB, IDX+_TAB_SIZE_)
...
#define _ag_get_ENV_TAB_(ENV)\
 _mem_get_exp_(CHK_AGR(ENV, _ENV_TAG_), ENV_TAB_INDEX)
                                                                                    //TOEGEVOEGD
#define _ag_get_MOD_DCT_(MOD)\
_mem_get_exp_(CHK_AGR(MOD, _MOD_TAG_), MOD_DCT_INDEX)
                                                                                    //TOEGEVOEGD
#define _ag_get_MOD_OWN_(MOD)\
_mem_get_exp_(CHK_AGR(MOD, _MOD_TAG_), MOD_OWN_INDEX)
                                                                                    //TOEGEVOEGD
#define _ag_get_MRF_MOD_(MRF)\
_mem_get_exp_(CHK_AGR(MRF, _MRF_TAG_), MRF_MOD_INDEX)
                                                                                    //TOEGEVOEGD
#define _ag_get_MRF_INV_(MRF)\
_mem_get_exp_(CHK_AGR(MRF, _MRF_TAG_), MRF_INV_INDEX)
...
#define _ag_set_NAT_NBR_(NAT, NBR)\
 _mem_set_exp_(CHK_AGR(NAT, _NAT_TAG_), NAT_NBR_INDEX, NBR)
                                                                                    ...
                                                                                    //AANGEPAST
#define _ag_set_TAB_OWN_(TAB, OWN)\
_mem_set_exp_(TAB, TAB_OWN_INDEX, OWN)
                                                                                    //AANGEPAST
#define _ag_set_TAB_EXP_(TAB, IDX, EXP)\
_mem_set_exp_(TAB, IDX+_TAB_SIZE_, EXP)
                                                                                    //AANGEPAST
#define _ag_set_TAB_CNT_(TAB, IDX, CNT)\
_mem_set_cnt_(TAB, IDX+_TAB_SIZE_, CNT)
...
#define _ag_set_ENV_TAB_(ENV, TAB)\
 _mem_set_exp_(CHK_AGR(ENV, _ENV_TAG_), ENV_TAB_INDEX, TAB)
                                                                                    //TOEGEVOEGD
#define _ag_set_MOD_DCT_(MOD, DCT)\
 _mem_set_exp_(CHK_AGR(MOD, _MOD_TAG_), MOD_DCT_INDEX, DCT)
                                                                                    //TOEGEVOEGD
#define _ag_set_MOD_OWN_(MOD, OWN)\
 _mem_set_exp_(CHK_AGR(MOD, _MOD_TAG_), MOD_OWN_INDEX, OWN)
                                                                                    //TOEGEVOEGD
#define _ag_set_MRF_MOD_(MRF, MOD)\
 _mem_set_exp_(CHK_AGR(MRF, _MRF_TAG_), MRF_MOD_INDEX, MOD)
                                                                                    //TOEGEVOEGD
#define _ag_set_MRF_INV_(MRF, INV)\
 _mem_set_exp_(CHK_AGR(MRF, _MRF_TAG_), MRF_INV_INDEX, INV)
...
typedef enum { _VOI_TAG_ = 0 ,
               ...
               _DCT_TAG_ = 11,
               _ENV_TAG_ = 12,
               _MOD_TAG_ = 13,                          //AANGEPAST
               _MRF_TAG_ = 14,                          //AANGEPAST
               _NY3_TAG_ = 15,
