...
/*   _MOD_ERROR_  ->  not a module                                        */
/*   _MRF_ERROR_  ->  not (public) in module                              */
/*   _IMT_ERROR_  ->  No permission to modify table                       */
/*------------------------------------------------------------------------*/
...
typedef enum { _DO_ESCAPE_   = -3,
               ...
               _USR_ERROR_   = 36,
               _ZDV_ERROR_   = 37,
               _MOD_ERROR_   = 38,                                                     //TOEGEVOEGD
               _MRF_ERROR_   = 39,                                                     //TOEGEVOEGD
               _IMT_ERROR_   = 40} _RES_TYPE_;                                         //TOEGEVOEGD
