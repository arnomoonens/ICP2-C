...
static _NIL_TYPE_ MRF(_NIL_TYPE_);                                              //TOEGEVOEGD
         ...
         switch (current_token)
           { case _LPR_TOKEN_:
             ...
             case _LBR_TOKEN_:
               ...
               _stk_push_CNT_(EXP);
               break;
             case _PER_TOKEN_:                                                            //TOEGEVOEGD
               READ_TOKEN();
               _stk_poke_CNT_(MRF);
               _stk_push_CNT_(REF); //Evalueer wat er achter de punt komt
               break;
             default:
               _stk_poke_CNT_(VAR); }
         break;
...
/*------------------------------------------------------------------------*/                                   //TOEGEVOEGD
/*  MRF                                                                   */
/*     expr-stack: [... ... ... ... VAR INV] -> [... ... ... ... ... MRF] */
/*     cont-stack: [... ... ... ... ... MRf] -> [... ... ... ... ... ...] */
/*------------------------------------------------------------------------*/
static _NIL_TYPE_ MRF(_NIL_TYPE_)
 { _EXP_TYPE_ var, inv, mrf;
   _mem_claim_();
   _stk_pop_EXP_(inv);
   _stk_peek_EXP_(var);
   mrf = _ag_make_MRF_();
     //Een module referentie bestaat uit de naam van de module en een invocatie van een element uit deze module
   _ag_set_MRF_INV_(mrf, inv);
   _ag_set_MRF_MOD_(mrf, var);
   _stk_poke_EXP_(mrf);
   _stk_zap_CNT_(); }
